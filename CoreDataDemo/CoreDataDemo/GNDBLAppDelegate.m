...
#import "GNDBLAppDelegate.h"

#import "GNDBLViewController.h"


@implementation GNDBLAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[GNDBLViewController alloc] initWithStyle:UITableViewStylePlain];
    NSManagedObjectContext *context = [self.viewController managedObjectContext];
    if (!context) {
        //Handle Error
    }
